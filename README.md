...
* [x] Add a continues workflow that triggers when data changes (M19) - NOT RELEVANT FOR OUR PROJECT
...
* [x] If applicable, optimize the performance of your data loading using distributed data loading (M29) - MADE OPTIMIZATIONS FOR SMALL DATASET
